...
The 2026-09-21 independent read-only pass covered all eight version-1 scenarios. It found a diagnosis-without-diff controller blocker and a `spec_version` documentation mismatch; the latter was corrected to `version`. That historical pass is not a formal 8×3 M qualification or a cross-model comparison.
