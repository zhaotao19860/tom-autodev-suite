...
7. Run `EvidenceGate` for plan coverage, repository ownership, change-set atomicity, and hash consistency.
8. Stop for G5 approval of the complete candidate diff before applying or submitting it.
