...
| `CODE_FAILURE` | `NPL_SDKLT_INTEGRATION` | NPL front-end/back-end evidence passed but generated table/action metadata, SDKLT, or LTT rejects the current mapping or leaves an action unconsumed | Preserve generated metadata and route through project integration diagnosis; do not retry NPL syntax |
